...
This automation framework ensures that YourMenu's core features (like Scan Menu, Book a Table, Book a Room, user login, and checkout) are thoroughly tested and function reliably.
